...
},{"../bower_components/bootstrap/dist/js/bootstrap":49,"backbone":"5kFNoY","chaplin":50,"jquery":"HlZQrA"}],2:[function(require,module,exports){
...
},{"../../views/site-view":46,"chaplin":50}],"controllers/base/controller":[function(require,module,exports){
...
},{"../views/bootstrap/jumbotron":40,"../views/footer":41,"../views/header":42,"../views/home/home-page":43,"./base/controller":"PL6FY2"}],"2KFWuv":[function(require,module,exports){
...
},{"../models/image":17,"../models/photos":18,"../views/bootstrap/jumbotron":40,"../views/footer":41,"../views/header":42,"../views/home/home-page":43,"../views/images-collection":44,"./base/controller":"PL6FY2","chaplin":50}],"controllers/image-controller":[function(require,module,exports){
module.exports=require('2KFWuv');
},{}],"controllers/stage-controller":[function(require,module,exports){
module.exports=require('u4brV/');
},{}],"u4brV/":[function(require,module,exports){
var Chaplin, Controller, Stage1View, StageController, StageModel,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = StageController = (function(_super) {
  ...
  StageController.prototype.index = function() {
    console.log('stage called');
    debugger;
    this.view = Stage1View;
    return this;
  };
...
},{"../models/stage":19,"./base/controller":"PL6FY2","chaplin":50}],11:[function(require,module,exports){
...
},{"chaplin":50}],13:[function(require,module,exports){
...
},{"chaplin":50,"hbsfy/runtime":"pu95bm"}],14:[function(require,module,exports){
...
},{"chaplin":50}],15:[function(require,module,exports){
...
},{"./model":16,"chaplin":50}],16:[function(require,module,exports){
var Chaplin, Model,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"chaplin":50}],17:[function(require,module,exports){
...
},{"./base/model":16}],18:[function(require,module,exports){
...
},{"../models/image":17,"./base/collection":15}],19:[function(require,module,exports){
...
module.exports = StageModel = (function(_super) {
  __extends(StageModel, _super);

  function StageModel() {
    return StageModel.__super__.constructor.apply(this, arguments);
  }
...
},{"./base/model":16}],20:[function(require,module,exports){
module.exports = function(match) {
  match('', 'home#index');
  match('test', 'image#index');
  return match('stage', 'stage#index');
};
...
},{"underscore":51}],"rN5+ME":[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":"pu95bm"}],"cziHUL":[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"stage-template-container\">\n  <div class=\"box\"></div>\n</div>\n";
  });

},{"hbsfy/runtime":"pu95bm"}],"../templates/stage":[function(require,module,exports){
module.exports=require('cziHUL');
...
},{"./view":39,"chaplin":50}],39:[function(require,module,exports){
var Chaplin, View,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../../lib/view-helper":13,"chaplin":50}],40:[function(require,module,exports){
...
},{"../../templates/jumbotron":"rN5+ME","../base/view":39}],41:[function(require,module,exports){
var FooterView, View,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../templates/footer":"9RsPKC","./base/view":39}],42:[function(require,module,exports){
var HeaderView, View,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../templates/header":"j00Jnv","./base/view":39}],43:[function(require,module,exports){
...
},{"../../templates/home":"s/yNEm","../base/view":39}],44:[function(require,module,exports){
var $, CollectionView, ImageModel, ImagesCollectionView, PhotoView, mediator, _,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = ImagesCollectionView = (function(_super) {
  ...
  ImagesCollectionView.prototype.initialize = function() {
    this.subscribeEvent('newImage', this.newImage);
  ...
  ImagesCollectionView.prototype.newImage = function() {
    return console.log('image added, called from published event');
  };
...
},{"../models/image":17,"../templates/photos":"2+wKAI","./base/collection-view":38,"./photo":45,"chaplin":50,"jquery":"HlZQrA","underscore":51}],45:[function(require,module,exports){
var $, PhotoView, View, mediator,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../templates/photo":"DAW7G5","./base/view":39,"chaplin":50,"jquery":"HlZQrA"}],46:[function(require,module,exports){
var SiteView, View,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../templates/site":"cL1PB2","./base/view":39}],47:[function(require,module,exports){
var $, Stage1View, StageModel, View, mediator,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Stage1View = (function(_super) {
  __extends(Stage1View, _super);

  function Stage1View() {
    return Stage1View.__super__.constructor.apply(this, arguments);
  }

  Stage1View.prototype.template = require('../templates/stage');

  Stage1View.prototype.autoRender = true;

  Stage1View.prototype.className = 'stage1';

  Stage1View.prototype.model = StageModel;

  Stage1View.prototype.initialize = function() {
    return console.log('init stage1');
  };
...
},{"../models/stage":19,"../templates/stage":"cziHUL","./base/view":39,"chaplin":50,"jquery":"HlZQrA"}],48:[function(require,module,exports){
var $, Stage1View, StageModel, View, mediator,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Stage1View = (function(_super) {
  ...
  Stage1View.prototype.className = 'stage2';
...
},{"../models/stage":19,"../templates/stage":"cziHUL","./base/view":39,"chaplin":50,"jquery":"HlZQrA"}],49:[function(require,module,exports){
/*!
...
},{"backbone":"5kFNoY","underscore":51}],51:[function(require,module,exports){
//     Underscore.js 1.5.2
